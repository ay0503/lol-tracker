...
const GAMES = [
  ...
  { id: "limbo", title: "Limbo", titleKo: "림보", emoji: "📈", desc: "Set target, beat the crash", descKo: "목표를 넘겨라", bet: "$0.10 - $50", href: "/casino/limbo", active: true, bg: "from-violet-950/50 to-purple-900/30", border: "border-violet-700/40", badge: "from-violet-500 to-purple-600" },
  ...
  { id: "wheel", title: "Wheel", titleKo: "휠", emoji: "🎡", desc: "Spin for multipliers", descKo: "배율을 돌려라", bet: "$0.10 - $50", href: "/casino/wheel", active: true, bg: "from-yellow-950/50 to-orange-900/30", border: "border-yellow-700/40", badge: "from-yellow-500 to-orange-600" },
